...
enum Field {
    static let paper      = Tone(r: 0.914, g: 0.886, b: 0.824)
    static let paperWarm  = Tone(r: 0.937, g: 0.910, b: 0.843)
    static let paperCool  = Tone(r: 0.886, g: 0.882, b: 0.851)
    static let cartridge  = Tone(r: 0.898, g: 0.867, b: 0.788)

    static let ink        = Tone(r: 0.114, g: 0.102, b: 0.090)
    static let inkSoft    = Tone(r: 0.243, g: 0.224, b: 0.204)
    static let inkPale    = Tone(r: 0.435, g: 0.412, b: 0.384)
    static let sepia      = Tone(r: 0.341, g: 0.259, b: 0.176)
    static let oxblood    = Tone(r: 0.529, g: 0.208, b: 0.169)
    static let carmine    = Tone(r: 0.678, g: 0.278, b: 0.243)

    static let seaBlue    = Tone(r: 0.549, g: 0.635, b: 0.667)
    static let seaDeep    = Tone(r: 0.361, g: 0.478, b: 0.522)
    static let shoal      = Tone(r: 0.784, g: 0.741, b: 0.639)
    static let sand       = Tone(r: 0.831, g: 0.769, b: 0.635)
    static let marsh      = Tone(r: 0.588, g: 0.620, b: 0.518)
    static let verdigris  = Tone(r: 0.396, g: 0.549, b: 0.502)
    static let moss       = Tone(r: 0.400, g: 0.463, b: 0.322)
    static let baize      = Tone(r: 0.216, g: 0.294, b: 0.243)
    static let baizeDark  = Tone(r: 0.129, g: 0.184, b: 0.157)
    static let brass      = Tone(r: 0.761, g: 0.612, b: 0.294)
    static let brassDark  = Tone(r: 0.510, g: 0.400, b: 0.180)
    static let bone       = Tone(r: 0.878, g: 0.855, b: 0.792)
    static let graphite   = Tone(r: 0.435, g: 0.435, b: 0.443)
    static let rust       = Tone(r: 0.588, g: 0.322, b: 0.196)
    static let night      = Tone(r: 0.090, g: 0.098, b: 0.106)
}
