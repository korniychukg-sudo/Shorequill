...
@MainActor
final class QuillLaunchGate: ObservableObject {
    ...
    private func attempt(_ n: Int) {
        ...
        let tracker = QuillGateTracker(checkDomain: checkDomain, ownHost: ownHost)
...
final class QuillGateTracker: NSObject, URLSessionTaskDelegate {
    var onProgress: (() -> Void)?
